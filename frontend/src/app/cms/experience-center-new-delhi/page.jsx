...
// const CmsExperienceCenterNewDelhi = () => {
...
//         try {
//             const response = await api.get(`/cms-parent-child/experience_center_new_delhi`, {
//                 headers: {
...
//         try {
//             const response = await api.get(`/cms-parent-child/experience_center_new_delhi_video`, {
//                 headers: {
//                     Authorization: `Bearer ${authToken}`, 
//                 },
//             });
...
//         formDataToSend.append("page_type", "experience_center_new_delhi");
//         formDataToSend.append("title", formData.title);
//         formDataToSend.append("description", formData.description);
//         if (formData.image) {
//             formDataToSend.append("image", formData.image);
...
//     const formDataToSend = new FormData();
//     formDataToSend.append("page_type", "experience_center_new_delhi_video");
//     formDataToSend.append("title", formData.title);
//     formDataToSend.append("description", formData.description);
//     if (formData.image) {
//         formDataToSend.append("image", formData.image);
...
//                 <h1 className="mb-4 text-center">CMS - New Delhi Experience Center</h1>
...
// export default CmsExperienceCenterNewDelhi;
