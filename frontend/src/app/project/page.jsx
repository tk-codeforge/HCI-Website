          ...
          <div className="my-5 oofer_card">
            <div className="container">
              <div className="row mx-0 g-4">
                <h2 className="pb-3 text-center">Our Projects</h2>
                <div className="col-lg-4 col-md-6 col-12">
                  <Card
                    cardNameALl="cardoffer"
                    imgSrc={"/images/project/residential.jpg"}
                    imgAlt={"room"}
                    imgClass={"Project_img"}
                    titleCard={"Residential Projects "}
                    descriptionCard={
                ...
                <div className="col-lg-4 col-md-6 col-12">
                  <Card
                    cardNameALl="cardoffer"
                    imgSrc={"/images/project/corporate.jpg"}
                    imgAlt={"room"}
                    imgClass={"Project_img"}
                    titleCard={"Corporate Projects "}
                    descriptionCard={
                      "The interior design of your dream begins with a concept"
                    }
                    buttonTextCard={"Know More"}
                ...
                <div className="col-lg-4 col-md-6 col-12">
                  <Card
                    cardNameALl="cardoffer"
                    imgSrc={"/images/project/latest-project.jpg"}
                    imgAlt={"room"}
                    imgClass={"Project_img"}
                    titleCard={"Latest Project Video"}
                    descriptionCard={
                      "The interior design of your dream begins with a concept"
                    }
                    buttonTextCard={"Know More"}
